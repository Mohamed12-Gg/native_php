...
<html lang="en" data-bs-theme="auto">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
      <form action="handle_registar.php" method="post">
        <img
          class="mb-4"
        ...
        <h1 class="h3 mb-3 fw-normal">Please register</h1>
         ...
         <?php if (!empty($_GET["msg"]) && $_GET["msg"] == "error") {
          echo "<div class='alert alert-danger'>You are already rigistar <a href='login.php'>Login now </a></div>";
         }?>
        ...
        <div class="form-floating mb-2">
          ...
          <?php if (isset($_SESSION["errors"]["password"])) { ?>
            <div class="text-danger"><?php echo $_SESSION["errors"]["password"]; ?></div>
          <?php
}?>
        </div>
        <div class="form-floating mb-3">
          ...
          <?php if (isset($_SESSION["errors"]["confirmpassword"])) { ?>
            <div class="text-danger"><?php echo $_SESSION["errors"]["confirmpassword"]; ?></div>
          <?php
}?>
        </div>
